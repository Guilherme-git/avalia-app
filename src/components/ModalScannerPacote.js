...
const CONFIG_TEXT = [
  ...
  {
    id: 2,
    text: '2. Posicione os QR CODE no centro da câmera e mantenha o celular estático.',
  },
];
...
const ModalScanner = ({ openModal, handleOpenModal, navigation }) => {
  ...
  const showModal = async (value) => {
    await AsyncStorage.setItem("@avalia_modal_scanner_pacote", JSON.stringify(value) )
  }
